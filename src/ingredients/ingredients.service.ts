...
const INGREDIENT_SEEDS: SeedIngredient[] = [
  ...
  },
  {
    ...
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { scores: { hydrationBoost: 20 } },
  },
  {
    name: 'Niacinamide',
    aliases: [],
    ...
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { scores: { barrierSupportBoost: 15 } },
  },
  {
  ...
  },
  {
    name: 'Panthenol',
    aliases: [],
    benefits: ['hydration', 'barrier_support', 'soothing', 'strengthening_hair'],
    risks: [],
    comedogenicRating: null,
    irritationRisk: 'low',
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { scores: { hydrationBoost: 15, barrierSupportBoost: 10 } },
  },
  {
    name: 'Ceramide NP',
    aliases: [],
    ...
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { scores: { barrierSupportBoost: 25 } },
  },
  {
    name: 'Fragrance',
    aliases: ['parfum'],
    benefits: [],
    risks: ['fragrance', 'irritant', 'sensitive_skin_risk', 'fragrance_allergen_risk'],
    comedogenicRating: null,
    irritationRisk: 'high',
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: {
      ...
      warnings: ['contains_fragrance', 'fragrance_allergen_risk'],
    },
  },
  {
    name: 'Alcohol Denat',
  ...
  },
  {
    ...
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { scores: { irritationPenalty: 10 } },
  },
  {
    name: 'Lactic Acid',
    aliases: [],
  ...
  },
  {
    ...
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { scores: { acneRiskPenalty: 10 } },
  },
  {
    name: 'Coconut Oil',
    ...
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { scores: { acneRiskPenalty: 30 }, warnings: ['comedogenic_risk'] },
  },
  {
    name: 'Sodium Lauryl Sulfate',
    aliases: ['sls'],
    benefits: [],
    risks: ['contains_sulfates', 'scalp_irritation_risk'],
    comedogenicRating: null,
    irritationRisk: 'high',
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { warnings: ['contains_sulfates', 'scalp_irritation_risk'] },
  },
  {
    name: 'Sodium Laureth Sulfate',
    aliases: ['sles'],
    benefits: [],
    risks: ['contains_sulfates'],
    comedogenicRating: null,
    irritationRisk: 'medium',
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { warnings: ['contains_sulfates'] },
  },
  {
    name: 'Dimethicone',
    aliases: [],
    ...
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { warnings: ['contains_heavy_silicones'] },
  },
  {
    name: 'Limonene',
    aliases: [],
    ...
    fungalAcneSafe: null,
    pregnancySafe: null,
    metadata: { warnings: ['fragrance_allergen_risk'] },
  },
  {
    name: 'Linalool',
    aliases: [],
...
export class IngredientsService implements OnModuleInit {
  ...
  analyzeIngredients(
    ...
    if (scores.irritationPenalty >= 30) warnings.push('sensitive_skin_risk');
  ...
  private async seedInitialIngredients() {
    ...
    this.logger.log(
      `Ingredient Intelligence seeded ${this.builtInIngredients.length} ingredients`,
    );
  }
  ...
  private getIngredientMetadata(ingredient: Ingredient): IngredientMetadata {
    ...
    return metadata as IngredientMetadata;
  }
