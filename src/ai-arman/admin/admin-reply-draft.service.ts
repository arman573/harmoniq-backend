...
const INSTRUCTIONS = [
  ...
  'Ett meddelande med sender "VERIFIERADE ORDERFAKTA" är den enda auktoritativa källan för aktuell orderstatus, leveransstatus, tracking och lagersaldo. Om verified=false, fältet saknas eller inget sådant meddelande finns ska du uttryckligen behandla uppgiften som okänd och aldrig fylla i den själv.',
